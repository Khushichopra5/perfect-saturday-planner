...
KNOWN_CITIES: tuple[KnownCity, ...] = (
    ...
    KnownCity("London", 51.5074, -0.1278, "USD"),
    KnownCity("San Francisco", 37.7749, -122.4194, "USD", ("sf", "bay area")),
    KnownCity("Singapore", 1.3521, 103.8198, "USD"),
    KnownCity("Dubai", 25.2048, 55.2708, "USD"),
    KnownCity("Tokyo", 35.6762, 139.6503, "USD"),
    KnownCity("Paris", 48.8566, 2.3522, "USD"),
    KnownCity("Berlin", 52.5200, 13.4050, "USD"),
    KnownCity("Sydney", -33.8688, 151.2093, "USD"),
)
